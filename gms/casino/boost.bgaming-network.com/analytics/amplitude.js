...
(() => {
  ...
  var __webpack_modules__ = {
    ...
    "../../node_modules/@growthbook/growthbook/dist/esm/GrowthBook.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */
        var dom_mutator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! dom-mutator */ "../../node_modules/dom-mutator/dist/dom-mutator.esm.js"
        );
        /* harmony import */
        var _util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ./util */ "../../node_modules/@growthbook/growthbook/dist/esm/util.js"
        );
        /* harmony import */
        var _mongrule__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./mongrule */ "../../node_modules/@growthbook/growthbook/dist/esm/mongrule.js"
        );
        /* harmony import */
        var _feature_repository__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./feature-repository */ "../../node_modules/@growthbook/growthbook/dist/esm/feature-repository.js"
          );
        ...
        class GrowthBook {
          ...
          async loadFeatures(options) {
            ...
            if (options && options.autoRefresh) {
              (0, _feature_repository__WEBPACK_IMPORTED_MODULE_1__.subscribe)(
                this
              );
            }
          }
          ...
          async _refresh(options, allowStale, updateInstance) {
            ...
            await (0,
            _feature_repository__WEBPACK_IMPORTED_MODULE_1__.refreshFeatures)(
              this,
              options.timeout,
          ...
          async setEncryptedFeatures(encryptedString, decryptionKey, subtle) {
            const featuresJSON = await (0,
            _util__WEBPACK_IMPORTED_MODULE_2__.decrypt)(
              encryptedString,
          ...
          async setEncryptedExperiments(
            encryptedString,
            decryptionKey,
            subtle
          ) {
            const experimentsJSON = await (0,
            _util__WEBPACK_IMPORTED_MODULE_2__.decrypt)(
              encryptedString,
              decryptionKey || this._ctx.decryptionKey,
              subtle
          ...
          destroy() {
            ...
            (0, _feature_repository__WEBPACK_IMPORTED_MODULE_1__.unsubscribe)(
              this
            );
                ...
                window
                  .fetch(
                    "https://rt.growthbook.io/?key="
                      ...
                      .concat(encodeURIComponent(JSON.stringify(q))),
                    {
                      cache: "no-cache",
                      mode: "no-cors",
                    }
          ...
          _isIncludedInRollout(
            ...
            const n = (0, _util__WEBPACK_IMPORTED_MODULE_2__.hash)(
              seed,
              hashValue,
              hashVersion || 1
            );
            ...
            return range
              ? (0, _util__WEBPACK_IMPORTED_MODULE_2__.inRange)(n, range)
              : coverage !== undefined
              ? n <= coverage
              : true;
          }
          _conditionPasses(condition) {
            return (0, _mongrule__WEBPACK_IMPORTED_MODULE_3__.evalCondition)(
              this.getAttributes(),
              condition
            );
          }
          _isFilteredOut(filters) {
            return filters.some((filter) => {
              ...
              return !filter.ranges.some((r) =>
                (0, _util__WEBPACK_IMPORTED_MODULE_2__.inRange)(n, r)
              );
            });
          }
          _run(experiment, featureId) {
            ...
            const qsOverride = (0,
            _util__WEBPACK_IMPORTED_MODULE_2__.getQueryStringOverride)(
              key,
              this._getContextUrl(),
              numVariations
            );
            ...
            if (
              ...
              key in this._ctx.forcedVariations
            ) {
            ...
            if (experiment.filters) {
              ...
              !(0, _util__WEBPACK_IMPORTED_MODULE_2__.inNamespace)(
                hashValue,
                experiment.namespace
              )
            ) {
            ...
            if (
              experiment.include &&
              !(0, _util__WEBPACK_IMPORTED_MODULE_2__.isIncluded)(
                experiment.include
              )
            ) {
              true &&
            ...
            if (
              experiment.groups &&
              !this._hasGroupOverlap(experiment.groups)
            ) {
              true &&
            ...
            if (
              ...
              !(0, _util__WEBPACK_IMPORTED_MODULE_2__.isURLTargeted)(
                this._getContextUrl(),
                experiment.urlPatterns
              )
            ) {
            ...
            const ranges =
              experiment.ranges ||
              (0, _util__WEBPACK_IMPORTED_MODULE_2__.getBucketRanges)(
                numVariations,
                experiment.coverage === undefined ? 1 : experiment.coverage,
                experiment.weights
              );
            const assigned = (0,
            _util__WEBPACK_IMPORTED_MODULE_2__.chooseVariation)(n, ranges);
          ...
          _mergeOverrides(experiment) {
            ...
            if (o && o[key]) {
              ...
              if (typeof experiment.url === "string") {
                experiment.url = (0,
                _util__WEBPACK_IMPORTED_MODULE_2__.getUrlRegExp)(
                  // eslint-disable-next-line
                  experiment.url
                );
              }
          ...
          _getResult(experiment, variationIndex, hashUsed, featureId, bucket) {
            ...
            if (
              variationIndex < 0 ||
              variationIndex >= experiment.variations.length
            ) {
              variationIndex = 0;
              inExperiment = false;
            }
          ...
          _applyDOMChanges(changes) {
            ...
            if (changes.domMutations) {
              changes.domMutations.forEach((mutation) => {
                undo.push(
                  dom_mutator__WEBPACK_IMPORTED_MODULE_0__[
                    "default"
                  ].declarative(mutation).revert
                );
              });
            }
            return () => {
    ...
    "../../node_modules/@growthbook/growthbook/dist/esm/feature-repository.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        function getKey(instance) {
          ...
          return [
            "".concat(apiHost, "||").concat(clientKey),
            apiHost,
            clientKey,
          ];
        }
        ...
        function onNewFeatureData(key, data) {
          ...
          instances &&
            instances.forEach((instance) => refreshInstance(instance, data));
        }
        ...
        function onSSEError(channel, apiHost, clientKey) {
          ...
          if (
            channel.errors > 3 ||
            (channel.src && channel.src.readyState === 2)
          ) {
        ...
        function enableChannel(channel, apiHost, clientKey) {
          channel.src = new polyfills.EventSource(
            "".concat(apiHost, "/sub/").concat(clientKey)
          );
    ...
    "../../node_modules/@growthbook/growthbook/dist/esm/mongrule.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        function isOperatorObject(obj) {
          ...
          return (
            keys.length > 0 &&
            keys.filter((k) => k[0] === "$").length === keys.length
          );
        }
        ...
        function getType(v) {
          ...
          const t = typeof v;
          if (
            ["string", "number", "boolean", "object", "undefined"].includes(t)
          ) {
            return t;
          }
          return "unknown";
        ...
        function evalOperatorCondition(operator, actual, expected) {
          switch (operator) {
            case "$veq":
              return (
                (0, _util__WEBPACK_IMPORTED_MODULE_0__.paddedVersionString)(
                  actual
                ) ===
                (0, _util__WEBPACK_IMPORTED_MODULE_0__.paddedVersionString)(
                  expected
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        function getBucketRanges(numVariations, coverage, weights) {
          ...
          if (coverage < 0) {
            if (true) {
              console.error(
                "Experiment.coverage must be greater than or equal to 0"
              );
            }
            coverage = 0;
          } else if (coverage > 1) {
            if (true) {
              console.error(
                "Experiment.coverage must be less than or equal to 1"
              );
            }
            coverage = 1;
          }
    ...
    "./src/common/const.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        __webpack_require__.d(__webpack_exports__, {
          /* harmony export */
          ANALYTICS_GAMES_LIST_API_URL: () =>
            /* binding */ ANALYTICS_GAMES_LIST_API_URL,
          /* harmony export */
          ...
          /* harmony export */
          EXTERNAL_INCOMING_ANALYTICS: () =>
            /* binding */ EXTERNAL_INCOMING_ANALYTICS,
          /* harmony export */
        ...
        var RUDDERSTACK_API_URL =
          "https://rudderstack.shared.bgaming-system.com" || 0;
        var ANALYTICS_GAMES_LIST_API_URL = true
          ? "https://boost.bgaming-network.com/" +
            "api/amplitudeGamesList?env=" +
            "development"
          : 0;
    ...
    "./src/experiment-manager/BEGrowthbookExperimentManager.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        __webpack_require__.d(__webpack_exports__, {
          /* harmony export */
          BEGrowthbookExperimentManager: () =>
            /* binding */ BEGrowthbookExperimentManager,
          /* harmony export */
        });
        /* harmony import */
        var _ExperimentManager__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./ExperimentManager */ "./src/experiment-manager/ExperimentManager.js"
          );
        ...
        var BEGrowthbookExperimentManager = /*#__PURE__*/ (function (
          _ExperimentManager
        ) {
          ...
          return _createClass(BEGrowthbookExperimentManager, [
            {
              ...
              value: function makeCreator() {
                ...
                return new GameOptionsExperimentProcessor(
                  (_window$__OPTIONS__ = window.__OPTIONS__) === null ||
                  _window$__OPTIONS__ === void 0
                    ? void 0
                    : _window$__OPTIONS__.growthbook_flags,
          ...
          return _createClass(GameOptionsExperimentProcessor, [
            ...
            },
            {
              ...
              value: function getFeature(featureName) {
                var _this$context;
                var featureData = Reflect.get(
                  (_this$context = this.context) === null ||
                    _this$context === void 0
                    ? void 0
                    : _this$context.features,
                  featureName
                );
                return featureData;
              },
            },
            {
              ...
              value: function getFeatureValue(featureName) {
                ...
                return featureData === null || featureData === void 0
                  ? void 0
                  : featureData.value;
              },
            },
    ...
    "./src/experiment-manager/ExperimentManager.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */
        var _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../common/AnalyticsAction */ "./src/common/AnalyticsAction.js"
          );
        /* harmony import */
        var _common_const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../common/const */ "./src/common/const.js"
        );
        /* harmony import */
        ...
        /* harmony import */
        var _engine_game_events__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! @engine/game-events */ "../game-events/src/game-events.js"
          );
        ...
        var ExperimentManager = /*#__PURE__*/ (function () {
          function ExperimentManager() {
            ...
            window.addEventListener(
              _common_const__WEBPACK_IMPORTED_MODULE_1__.GROWTHBOOK_IINCOMING,
              this.handleIncomingMessage.bind(this)
            );
            window.addEventListener(
              _common_const__WEBPACK_IMPORTED_MODULE_1__.ANALYTICS_INCOMING,
              this.handleAnalyticsIncomingMessage.bind(this)
            );
          ...
          return _createClass(ExperimentManager, [
            {
              ...
              value: function handleGameEvent(eventName, targetName, context) {
                switch (eventName) {
                  case _engine_game_events__WEBPACK_IMPORTED_MODULE_3__[
                    "default"
                  ].START_LOADING: {
            ...
            },
            {
              ...
              value: function handleAnalyticsIncomingMessage(_ref) {
                ...
                if (
                  message.type ===
                  _common_const__WEBPACK_IMPORTED_MODULE_1__.incomingMessageType
                    .start
                ) {
                ...
                window.removeEventListener(
                  _common_const__WEBPACK_IMPORTED_MODULE_1__.ANALYTICS_INCOMING,
                  this.handleAnalyticsIncomingMessage
                );
              },
            },
            {
              ...
              value: function handleIncomingMessage(_ref2) {
                ...
                switch (message.type) {
                  case _common_const__WEBPACK_IMPORTED_MODULE_1__
                    .incomingMessageType.addFeature:
                    this.addFeatureHandler(
            ...
            },
            {
              ...
              value: function start() {
                ...
                this.manager.loadFeatures().then(function () {
                  var _this$manager;
                  if (
                    (_this$manager = _this.manager) !== null &&
                    _this$manager !== void 0 &&
                    (_this$manager = _this$manager.context) !== null &&
                    _this$manager !== void 0 &&
                    _this$manager.features
                  ) {
                    Object.keys(_this.manager.context.features).forEach(
                      function (f) {
                        return _this.manager.evalFeature(f);
                      }
                    );
                    if (_this.experiments.size === 0) {
                      _this.sendMessageToTracker(
                        _common_const__WEBPACK_IMPORTED_MODULE_1__
                          .incomingMessageType.updateUser,
                        {
                          target: "TrackID",
                          source: "None",
                        }
                  ...
                  window.dispatchEvent(
                    (0, _common_utils__WEBPACK_IMPORTED_MODULE_2__.createEvent)(
                      _common_const__WEBPACK_IMPORTED_MODULE_1__.GROWTHBOOK_OUTGOING,
                      {
                        type: _common_const__WEBPACK_IMPORTED_MODULE_1__
                          .outgoingMessageType.ready,
                        payload: _this,
                      }
                    )
                  );
            ...
            },
            {
              ...
              value: function addFeatureHandler(featureName, handler) {
                if (typeof handler === "function") {
                  ...
                  console.warn(
                    "[GROWTHBOOK] Feature handler must be provided as function",
                    featureName,
                    handler
                  );
                }
              ...
              value: function isFeatureEnabled(featureName) {
                ...
                return (
                  ...
                  _this$manager2 === void 0
                    ? void 0
                    : _this$manager2.isOn(featureName)) || false
                );
              },
            },
            {
              ...
              value: function getFeature(featureName) {
                var _this$manager3;
                return (_this$manager3 = this.manager) === null ||
                  _this$manager3 === void 0
                  ? void 0
                  : _this$manager3.getFeature(featureName);
              },
            },
            {
              key: "getFeatureValue",
              value: function getFeatureValue(featureName) {
                var _this$manager4;
                return (_this$manager4 = this.manager) === null ||
                  _this$manager4 === void 0
                  ? void 0
                  : _this$manager4.getFeatureValue(featureName);
              },
            },
            {
            ...
            },
            {
              ...
              value: function trackExperimentResult(
                experimentName,
                analyticsResult
              ) {
                ...
                if (
                  ...
                  analyticsResult !== void 0 &&
                  analyticsResult.TrackID
                ) {
                  this.sendMessageToTracker(
                    _common_const__WEBPACK_IMPORTED_MODULE_1__
                      .incomingMessageType.updateUser,
                ...
                if (this.isUnknownExperiment(experimentName)) {
                  this.sendMessageToTracker(
                    _common_const__WEBPACK_IMPORTED_MODULE_1__
                      .incomingMessageType.track,
                    {
                      target:
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_0__
                          .AnalyticsAction.TRACK_GROWTHBOOK_EXPERIMENT,
            ...
            },
            {
              ...
              value: function isUnknownExperiment(experimentName) {
                ...
                var experiments =
                  (_this$game$settings = this.game.settings) === null ||
                  _this$game$settings === void 0
                    ? void 0
                    : _this$game$settings.getItem(this.key, {});
                if (
                  experimentName &&
                  experiments &&
                  !(experimentName in experiments)
                ) {
    ...
    "./src/experiment-manager/GrowthbookExperimentManager.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        __webpack_require__.d(__webpack_exports__, {
          /* harmony export */
          GrowthbookExperimentManager: () =>
            /* binding */ GrowthbookExperimentManager,
          /* harmony export */
        });
        /* harmony import */
        var _growthbook_growthbook__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! @growthbook/growthbook */ "../../node_modules/@growthbook/growthbook/dist/esm/GrowthBook.js"
          );
        /* harmony import */
        var _ExperimentManager__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
         ...
         */
        var GrowthbookExperimentManager = /*#__PURE__*/ (function (
          _ExperimentManager
        ) {
          ...
          return _createClass(GrowthbookExperimentManager, [
            {
              ...
              value: function makeCreator() {
                ...
                return new _growthbook_growthbook__WEBPACK_IMPORTED_MODULE_2__.GrowthBook(
                  {
                    apiHost:
                      _common_const__WEBPACK_IMPORTED_MODULE_1__.GROWTHBOOK_API_HOST,
                    clientKey:
                      _common_const__WEBPACK_IMPORTED_MODULE_1__.GROWTHBOOK_SDK_KEY,
                    attributes: {
                      ...
                      affiliate: ""
                        .concat(
                          (_window$__OPTIONS__ = window.__OPTIONS__) === null ||
                            _window$__OPTIONS__ === void 0
                            ? void 0
                            : _window$__OPTIONS__.server_id,
                          "-"
                        )
                        .concat(
                          ((_window$__OPTIONS__2 = window.__OPTIONS__) ===
                            null ||
                          _window$__OPTIONS__2 === void 0 ||
                          (_window$__OPTIONS__2 = _window$__OPTIONS__2.ui) ===
                            null ||
                          _window$__OPTIONS__2 === void 0 ||
                          (_window$__OPTIONS__2 =
                            _window$__OPTIONS__2.brand) === null ||
                          _window$__OPTIONS__2 === void 0
                            ? void 0
                            : _window$__OPTIONS__2.name) || ""
                        ),
                    },
            ...
            },
            {
              ...
              value: function sendMessageToTracker(type, payload) {
                console.log(
                  "[GrowthbookExperimentManager] sendMessageToTracker",
                  type,
                  payload
                );
                _superPropGet(
    ...
    "./src/experiment-manager/index.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        __webpack_require__.d(__webpack_exports__, {
          /* harmony export */
          BEGrowthbookExperimentManager: () =>
            /* reexport safe */ _BEGrowthbookExperimentManager__WEBPACK_IMPORTED_MODULE_1__.BEGrowthbookExperimentManager,
          /* harmony export */
          GrowthbookExperimentManager: () =>
            /* reexport safe */ _GrowthbookExperimentManager__WEBPACK_IMPORTED_MODULE_0__.GrowthbookExperimentManager,
          /* harmony export */
        });
        /* harmony import */
        var _GrowthbookExperimentManager__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./GrowthbookExperimentManager */ "./src/experiment-manager/GrowthbookExperimentManager.js"
          );
        /* harmony import */
        var _BEGrowthbookExperimentManager__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./BEGrowthbookExperimentManager */ "./src/experiment-manager/BEGrowthbookExperimentManager.js"
          );
    ...
    "./src/tracker/GameTracker.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */
        var _common_const__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ../common/const */ "./src/common/const.js"
        );
        /* harmony import */
        var _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../common/AnalyticsAction */ "./src/common/AnalyticsAction.js"
          );
        /* harmony import */
        var _engine_game_events__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! @engine/game-events */ "../game-events/src/game-events.js"
          );
        /* harmony import */
        var _AnalyticsEvent__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ./AnalyticsEvent */ "./src/tracker/AnalyticsEvent.js"
        );
        /* harmony import */
        var _EventHistory__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./EventHistory */ "./src/tracker/EventHistory.js"
        );
        /* harmony import */
        var _roundSeriesId__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
          /*! ./roundSeriesId */ "./src/tracker/roundSeriesId.js"
        );
        /* harmony import */
        var _common_utils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
          /*! ../common/utils */ "./src/common/utils.js"
        );
        /* harmony import */
        var ua_parser_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
          /*! ua-parser-js */ "../../node_modules/ua-parser-js/src/main/ua-parser.mjs"
        );
        /* harmony import */
        var _RudderStackGameTracker__WEBPACK_IMPORTED_MODULE_8__ =
          __webpack_require__(
            /*! ./RudderStackGameTracker */ "./src/tracker/RudderStackGameTracker.js"
          );
        ...
        var GameTracker = /*#__PURE__*/ (function () {
          function GameTracker() {
            ...
            _defineProperty(this, "buyFeatures", [
              _common_const__WEBPACK_IMPORTED_MODULE_0__.buyFeatures.bonusBuy,
              _common_const__WEBPACK_IMPORTED_MODULE_0__.buyFeatures
                .freespinBuy,
            ]);
            _defineProperty(this, "gameFeatures", {
              states: [
                _common_const__WEBPACK_IMPORTED_MODULE_0__.features.freespins,
                _common_const__WEBPACK_IMPORTED_MODULE_0__.features.respin,
              ],
              commands: [
                _common_const__WEBPACK_IMPORTED_MODULE_0__.featuresCommands
                  .freespin,
                _common_const__WEBPACK_IMPORTED_MODULE_0__.featuresCommands
                  .respin,
              ],
            });
            _defineProperty(this, "finishStates", [
              _common_const__WEBPACK_IMPORTED_MODULE_0__.gameFinishStates
                .closed,
              _common_const__WEBPACK_IMPORTED_MODULE_0__.gameFinishStates
                .gamble,
            ]);
            _defineProperty(
              this,
              "history",
              new _EventHistory__WEBPACK_IMPORTED_MODULE_4__.EventHistory()
            );
            ...
            _defineProperty(
              this,
              "rsTracker",
              new _RudderStackGameTracker__WEBPACK_IMPORTED_MODULE_8__.RudderStackGameTracker()
            );
            /**
            ...
            this.userID =
              ((_window$__OPTIONS__ = window.__OPTIONS__) === null ||
              _window$__OPTIONS__ === void 0 ||
              (_window$__OPTIONS__ = _window$__OPTIONS__.lobby_v2_options) ===
                null ||
              _window$__OPTIONS__ === void 0
                ? void 0
                : _window$__OPTIONS__.player_id) || "unknown";
            window.addEventListener(
              _common_const__WEBPACK_IMPORTED_MODULE_0__.ANALYTICS_INCOMING,
              this.handleIncomingMessages.bind(this)
            );
            window.addEventListener(
              _common_const__WEBPACK_IMPORTED_MODULE_0__.EXTERNAL_INCOMING_ANALYTICS,
          ...
          return _createClass(GameTracker, [
            {
              ...
              value: (function () {
                var _checkIfEventSendingIsAllowed = _asyncToGenerator(
                          ...
                          switch ((_context.prev = _context.next)) {
                            case 0:
                              gameName =
                                ((_window = window) === null ||
                                _window === void 0 ||
                                (_window = _window.__OPTIONS__) === null ||
                                _window === void 0
                                  ? void 0
                                  : _window.identifier) || "unknownName";
                              _context.prev = 1;
                              _context.next = 4;
                              return fetch(
                                _common_const__WEBPACK_IMPORTED_MODULE_0__.ANALYTICS_GAMES_LIST_API_URL
                              );
                            case 4:
                              res = _context.sent;
                              if (res.ok) {
            ...
            },
            {
              ...
              value: function handleIncomingMessages(_ref) {
                ...
                var message = _ref.detail;
                switch (message.type) {
                  case _common_const__WEBPACK_IMPORTED_MODULE_0__
                    .incomingMessageType.start:
                    this.notifyTrackerInitialized(message.payload);
                    if (
                      !(
                        (_message$payload = message.payload) !== null &&
                        _message$payload !== void 0 &&
                        _message$payload.skipTrackingEvents
                      )
                    ) {
            ...
            },
            {
              ...
              value: function handleExternalEvent(_ref2) {
                ...
                var newActionData = this.addExtraData(
                  eventName,
                  _objectSpread({}, eventData)
                );
                console.log(
                  "[RSA] track external event",
                  eventName,
                  newActionData
                );
            ...
            },
            {
              ...
              value: function notifyTrackerInitialized(payload) {
                // notify about Loaded
                window.dispatchEvent(
                  (0, _common_utils__WEBPACK_IMPORTED_MODULE_6__.createEvent)(
                    _common_const__WEBPACK_IMPORTED_MODULE_0__.ANALYTICS_OUTGOING,
                    {
                      type: _common_const__WEBPACK_IMPORTED_MODULE_0__
                        .outgoingMessageType.initialized,
                      payload: this,
                    }
                  )
                );
            ...
            },
            {
              ...
              value: function trackPageView() {
                var _window2,
                  _window3,
                  _window$__OPTIONS__2,
                  _window$__OPTIONS__3,
                  _window$__OPTIONS__4,
                  _window$__OPTIONS__5,
                  _window4,
                  _window$__OPTIONS__6;
                var storedUserId =
                  ...
                  _window2 === void 0
                    ? void 0
                    : _window2.getItem("gameTracker_userId")) || null;
                if (storedUserId === null) {
                  this.userProperties["userIDchanged"] = "unknown";
                  this.userProperties["prevUserID"] = "unknown";
                } else {
                  this.userProperties["userIDchanged"] =
                    String(storedUserId) === String(this.userID)
                      ? "false"
                      : "true";
                ...
                (_window3 = window) === null ||
                  _window3 === void 0 ||
                  (_window3 = _window3.localStorage) === null ||
                  _window3 === void 0 ||
                  _window3.setItem("gameTracker_userId", String(this.userID));
                this.userProperties["userID"] = this.userID;
                this.userProperties["Affiliate"] = ""
                  .concat(
                    (_window$__OPTIONS__2 = window.__OPTIONS__) === null ||
                      _window$__OPTIONS__2 === void 0
                      ? void 0
                      : _window$__OPTIONS__2.server_id,
                    "-"
                  )
                  .concat(
                    ((_window$__OPTIONS__3 = window.__OPTIONS__) === null ||
                    _window$__OPTIONS__3 === void 0 ||
                    (_window$__OPTIONS__3 = _window$__OPTIONS__3.ui) === null ||
                    _window$__OPTIONS__3 === void 0 ||
                    (_window$__OPTIONS__3 = _window$__OPTIONS__3.brand) ===
                      null ||
                    _window$__OPTIONS__3 === void 0
                      ? void 0
                      : _window$__OPTIONS__3.name) || "unknown"
                  );
                this.userProperties["Skin"] =
                  ((_window$__OPTIONS__4 = window.__OPTIONS__) === null ||
                  _window$__OPTIONS__4 === void 0 ||
                  (_window$__OPTIONS__4 = _window$__OPTIONS__4.ui) === null ||
                  _window$__OPTIONS__4 === void 0
                    ? void 0
                    : _window$__OPTIONS__4.applied_skin) ||
                  ((_window$__OPTIONS__5 = window.__OPTIONS__) === null ||
                  _window$__OPTIONS__5 === void 0 ||
                  (_window$__OPTIONS__5 = _window$__OPTIONS__5.ui) === null ||
                  _window$__OPTIONS__5 === void 0
                    ? void 0
                    : _window$__OPTIONS__5.skin) ||
                  "unknown";
                this.userProperties["Game"] =
                  (_window4 = window) === null ||
                  _window4 === void 0 ||
                  (_window4 = _window4.__OPTIONS__) === null ||
                  _window4 === void 0
                    ? void 0
                    : _window4.identifier;
                this.userProperties["Currency"] =
                  (_window$__OPTIONS__6 = window.__OPTIONS__) === null ||
                  _window$__OPTIONS__6 === void 0
                    ? void 0
                    : _window$__OPTIONS__6.currency;
                this.identify(this.userID, this.userProperties);
                var browserData = (0,
                ua_parser_js__WEBPACK_IMPORTED_MODULE_7__.UAParser)(
                ...
                this.sendAction(
                  _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                    .AnalyticsAction.PAGE_VIEW,
                  data
                );
              },
            ...
            },
            {
              ...
              value: function startSession(gameName) {
                ...
                var data = {
                  ...
                  "Screen Resolution": ""
                    .concat(this.game.W, "x")
                    .concat(this.game.H),
                  Orientation: this.game.isMobile.any
                ...
                this.sendAction(
                  _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                    .AnalyticsAction.SESSION_STARTED,
                  data
                );
                window.dispatchEvent(
                  (0, _common_utils__WEBPACK_IMPORTED_MODULE_6__.createEvent)(
                    ...
                    {
                      type: _common_const__WEBPACK_IMPORTED_MODULE_0__
                        .outgoingMessageType.sessionStarted,
                      payload: this,
                    }
                  )
                );
            ...
            },
            {
              ...
              value: function startTrackingEvents() {
                ...
                (_window5$trackGameEve = (_window5 = window)
                  .trackGameEventListeners) !== null &&
                _window5$trackGameEve !== void 0
                  ? _window5$trackGameEve
                  : (_window5.trackGameEventListeners = []);
                window.trackGameEventListeners.push(this.gameEventHandler);
                this.currencyRate =
                  parseFloat(
                    (_window$__OPTIONS__7 = window.__OPTIONS__) === null ||
                      _window$__OPTIONS__7 === void 0
                      ? void 0
                      : _window$__OPTIONS__7.actual_currency_rate
                  ) || 0;
              },
              /**
            ...
            },
            {
              ...
              value: function gameEventHandler(eventName, targetName, data) {
                ...
                try {
                  switch (eventName) {
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].START_LOADING:
                      this.game = data.game;
                      window.dispatchEvent(
                        (0,
                        _common_utils__WEBPACK_IMPORTED_MODULE_6__.createEvent)(
                          _common_const__WEBPACK_IMPORTED_MODULE_0__.ANALYTICS_OUTGOING,
                          {
                            type: _common_const__WEBPACK_IMPORTED_MODULE_0__
                              .outgoingMessageType.ready,
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_BET_PANEL_OPENED:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.BET_CHANGE_SETTINGS_SHOWN,
                        {
                          Source: data || "Panel",
                        }
                      );
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_BET_PANEL_CLOSED:
                      if (
                        !this.history.hasEvent(
                          _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                            "default"
                          ].BET_CHANGED
                        )
                      ) {
                        this.sendAction(
                          _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                            .AnalyticsAction.BET_CHANGE_SETTINGS_CLOSED
                        );
                      }
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_SETTINGS_OPENED:
                      this.latestKnownVolume = this.game.Sound.fullVol;
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.SETTINGS_SHOWN
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      ...
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.MENU_CLOSED
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_SETTINGS_CLOSED:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.SETTINGS_CLOSED
                      );
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      ...
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.HELP_SCREEN_SHOWN
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                      ...
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.HELP_SCREEN_CLOSED
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_PAYTABLE_OPENED:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.PAYTABLE_SCREEN_SHOWN
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                      ...
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.PAYTABLE_SCREEN_CLOSED
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_AUTOSPINS_PANEL_OPENED:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.AUTOSPIN_MODE_SCREEN_SHOWN
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_AUTOSPINS_PANEL_CLOSED:
                      // not sure if it works at all (I mean history check logic)
                      if (!this.history.hasEvent("autospin-start-", false)) {
                        this.sendAction(
                          _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                            .AnalyticsAction.AUTOSPIN_MODE_SCREEN_CLOSED
                        );
                      }
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      ...
                      (0,
                      _roundSeriesId__WEBPACK_IMPORTED_MODULE_5__.requestRoundSeriesRefresh)();
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].PLAY:
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      ...
                      break;
                    case _AnalyticsEvent__WEBPACK_IMPORTED_MODULE_3__
                      .AnalyticsEvent.TRACK_ACTION:
                      this.sendAction(targetName, data);
                      break;
                    case _AnalyticsEvent__WEBPACK_IMPORTED_MODULE_3__
                      .AnalyticsEvent.UPDATE_USER_PROPERTY:
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_QUICK_SPIN_OFFER_OPENED:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.QUICK_SPIN_OFFER_POPUP_SHOWN
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                      ...
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.QUICK_SPIN_OFFER_POPUP_CLOSED
                      );
                      break;
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_QUICK_SPIN_MODE_ENABLED:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.QUICK_SPIN_MODE_ENABLED,
                        {
                          Source: data,
                        }
                      );
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_QUICK_SPIN_MODE_DISABLED:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.QUICK_SPIN_MODE_DISABLED,
                        {
                          Source: data,
                        }
                      );
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_ALL_SOUNDS_ON:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.ALL_SOUNDS_ON
                      );
                      break;
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_ALL_SOUNDS_OFF:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.ALL_SOUNDS_OFF
                      );
                      break;
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      ...
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.SOUND_FX_ON
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_SOUND_FX_OFF:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.SOUND_FX_OFF
                      );
                      break;
                    ...
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_SPACEBAR_TO_SPIN_ENABLED:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.SPACEBAR_TO_SPIN_ENABLED
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_SPACEBAR_TO_SPIN_DISABLED:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.SPACEBAR_TO_SPIN_DISABLED
                      );
                      break;
                    case _engine_game_events__WEBPACK_IMPORTED_MODULE_2__[
                      "default"
                    ].GAME_UI_BUY_BONUS_SCREEN_SHOWN:
                      this.sendAction(
                        _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                          .AnalyticsAction.BUY_BONUS_SCREEN_SHOWN,
                        {
                          Source: "UI",
                        }
                      );
            ...
            },
            {
              ...
              value: function addExtraData(actionName, actionData) {
                var roundSeriesState = (0,
                _roundSeriesId__WEBPACK_IMPORTED_MODULE_5__.getRoundSeriesState)();
                if (
                  actionName !== "Spin Started" &&
                  roundSeriesState.needsRefresh
                ) {
                  (0,
                  _roundSeriesId__WEBPACK_IMPORTED_MODULE_5__.createNewRoundSeriesId)();
                }
                if (!actionData) {
                  actionData = {};
                }
                ...
                if (window.extraData && window.extraData.round_series_id) {
                  actionData.round_series_id = ""
                    .concat(window.extraData.round_series_id, "_")
                    .concat(roundSeriesState.playerId);
                }
                if (actionName !== "Spin Started") {
                  (0,
                  _roundSeriesId__WEBPACK_IMPORTED_MODULE_5__.clearRoundSeriesRefreshFlag)();
                }
                return actionData;
              },
            },
            ...
            },
            {
              ...
              value: function _handleBetChange(eventData) {
                ...
                if (eventData.source === "Buy Bonus Screen") {
                  data.Type =
                    eventData.currentBet > eventData.previousBet
                      ? "Plus Button"
                      : "Minus Button";
            ...
            },
            {
              ...
              value: function _handleVolumeChange() {
                ...
                if (currentVolume !== this.latestKnownVolume) {
                  ...
                  this.sendAction(
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.VOLUME_CHANGED,
                    {
              ...
              value: function _handleAutoSpinsStart() {
                ...
                var onSpinHandle =
                  arguments.length > 1 && arguments[1] !== undefined
                    ? arguments[1]
                    : false;
                var isAdvancedStopConditionsUsed =
                  withRules ||
                  this.game.data.stopAutospinsOnAnyWin ||
                  this.game.data.stopIfSingleWinExceeds ||
                  this.game.data.stopOnCashBalanceIncreasedBy ||
                  this.game.data.stopOnCashBalanceDecreasedBy ||
                  this.game.data.stopAutospinsIfBonusGameIsWon;
                this.sendAction(
                  _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                    .AnalyticsAction.AUTOSPIN_MODE_STARTED,
                  {
                    Count: this.game.data.autospinsCountInfinity
                      ? "Infinity"
                      : this.game.data.autospinsCount + Number(onSpinHandle),
                    "Advanced Mode": isAdvancedStopConditionsUsed
                      ? "Yes"
                      : "No",
                  }
                );
            ...
            },
            {
              ...
              value: function _handleAutoSpinsStop(reason) {
                this.sendAction(
                  _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                    .AnalyticsAction.AUTOSPIN_MODE_FINISHED,
                  {
            ...
            },
            {
              ...
              value: function _handleSpin(spinData) {
                var _this$_checkFeatures = this._checkFeatures(spinData),
                  isPurchasedRoundFinished =
                    _this$_checkFeatures.isPurchasedRoundFinished,
                ...
                var bet =
                  (spinData !== null &&
                    spinData !== void 0 &&
                    spinData.isFreeRound) ||
                  !isFeatureFinished
                    ? this.game.data.balanceChargedForSpin
                    : this.game.data.bet;
                var spinCost = bet / this.game.data.currencyDivider;
                var revenueData = {
                  $revenue: +(this.currencyRate * spinCost).toFixed(5),
                  $revenueType:
                    (spinData === null || spinData === void 0
                      ? void 0
                      : spinData.purchasedFeature) ||
                    (spinData !== null &&
                    spinData !== void 0 &&
                    spinData.isFreeRound
                      ? "Bonus round"
                ...
                var win = isFeatureFinished
                  ? spinData.gameTotalWin
                  : spinData.win;
                var spinButtonClickType =
                  this.spinButtonClickType === "hotkey"
                    ? "Manual Keyboard"
                    : "Manual Click";
                var spinButtonClickMode =
                  this.spinButtonClickType === "autorepeat" ? "Hold" : "Single";
                var data = _objectSpread(
                  _objectSpread(
                    {
                      Type:
                        ...
                        spinData.isAutoSpin
                          ...
                          : (spinData === null || spinData === void 0
                              ? void 0
                              : spinData.spinType) || spinButtonClickType,
                      Mode:
                        (spinData === null || spinData === void 0
                          ? void 0
                          : spinData.spinMode) || spinButtonClickMode,
                      "Quick Mode": this.game.settings.getItem("quickSpin")
                        ? "On"
                        : "Off",
                      "Multiplying Chance":
                        (spinData === null || spinData === void 0
                          ? void 0
                          : spinData.purchasedFeature) || "No",
                      Orientation: this.game.isMobile.any
                        ? this.game.isPortrait
                          ? "Portrait"
                          : "Landscape"
                  ...
                  {},
                  {
                    $profit: +(
                      revenueData.$revenue -
                      (win / this.game.data.currencyDivider) * revenueData.rate
                    ).toFixed(5),
                  }
                );
                var isFeatureBought = this.buyFeatures.some(function (
                  featureName
                ) {
                  ...
                  return !!(
                    spinData !== null &&
                    spinData !== void 0 &&
                    (_spinData$purchasedFe = spinData.purchasedFeature) !==
                      null &&
                    _spinData$purchasedFe !== void 0 &&
                    _spinData$purchasedFe.includes(featureName)
                  );
                });
                if (isFeatureBought) {
                  this.sendAction(
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.BUY_BONUS_PURCHASED,
                    _objectSpread(
                      _objectSpread(
                        {
                ...
                if (isPurchasedRoundFinished) {
                  ...
                  var prices =
                    (_this$game$data = this.game.data) === null ||
                    _this$game$data === void 0
                      ? void 0
                      : _this$game$data.bonusPrices;
                  var featureName =
                    (_spinData$gameFlow = spinData.gameFlow) === null ||
                    _spinData$gameFlow === void 0 ||
                    (_spinData$gameFlow =
                      _spinData$gameFlow.purchased_feature) === null ||
                    _spinData$gameFlow === void 0
                      ? void 0
                      : _spinData$gameFlow.name;
                  var level =
                    (_spinData$gameFlow2 = spinData.gameFlow) === null ||
                    _spinData$gameFlow2 === void 0 ||
                    (_spinData$gameFlow2 =
                      _spinData$gameFlow2.purchased_feature) === null ||
                    _spinData$gameFlow2 === void 0
                      ? void 0
                      : _spinData$gameFlow2.level;
                  var bonusPrice = 0;
                  if (prices) {
                    bonusPrice = level
                      ? prices[featureName][level]
                      : prices[featureName];
                  } else {
                    var _this$game$data$initD;
                    var featureMultipliers =
                      (_this$game$data$initD =
                        this.game.data.initData.options) === null ||
                      _this$game$data$initD === void 0 ||
                      (_this$game$data$initD =
                        _this$game$data$initD.feature_options) === null ||
                      _this$game$data$initD === void 0
                        ? void 0
                        : _this$game$data$initD.feature_multipliers;
                    var baseBet = featureMultipliers.base_bet || 100;
                    var _bet = this.game.currentScene.getBet();
                    if (featureMultipliers) {
                      var featureMultiplier = level
                        ? featureMultipliers[featureName][level]
                        : featureMultipliers[featureName];
                      bonusPrice = level
                        ? Math.ceil((featureMultiplier / baseBet) * _bet)
                        : Math.ceil((featureMultiplier / baseBet) * _bet);
                    }
                  }
                  this.sendAction(
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.BUY_BONUS_FINISHED,
                    _objectSpread(
                      _objectSpread(
                        {
                          Type: featureName,
                      ...
                      {
                        $profit: +(
                          ((bonusPrice - spinData.gameTotalWin) *
                            revenueData.rate) /
                          this.game.data.currencyDivider
                        ).toFixed(5),
                      }
                    )
                  );
                ...
                if (
                  ...
                  if (
                    this.isAutoSpinInProgress &&
                    this.game.data.autospinsCount === 0 &&
                    !this.game.data.autospinsCountInfinity
                  ) {
              ...
              value: function _handleButtonClick(buttonName, data) {
                ...
                if (buttonName === "mute-button-on") {
                  ...
                  Promise.resolve().then(function () {
                    _this2.sendAction(
                      _this2.game.Sound.musicEnabled
                        ? _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                            .AnalyticsAction.MUSIC_ON
                        : _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                            .AnalyticsAction.MUSIC_OFF
                  ...
                  Promise.resolve().then(function () {
                    _this2.sendAction(
                      _this2.game.Sound.soundEnabled
                        ? _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                            .AnalyticsAction.SOUND_FX_ON
                        : _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                            .AnalyticsAction.SOUND_FX_OFF
                  ...
                  buttonName === "settings-quick-spin" ||
                  buttonName === "quick-spin-check"
                ) {
                  this._scheduleOptionsTrack(
                    "quickSpin",
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.QUICK_SPIN_MODE_ENABLED,
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                  ...
                  buttonName === "bonus-btn" ||
                  buttonName === "buy-bonus-button"
                ) {
                  this.sendAction(
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.BUY_BONUS_SCREEN_SHOWN,
                  ...
                  this.sendAction(
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.BUY_BONUS_SCREEN_CLOSED
                  );
                  ...
                  this._scheduleOptionsTrack(
                    "isLeftHandedUI",
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.LEFT_HAND_MODE_ENABLED,
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.LEFT_HAND_MODE_DISABLED
                  );
                } else if (buttonName === "settings-spacebar-to-spin") {
                  this._scheduleOptionsTrack(
                    "isSpaceBarToSpinEnabled",
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.SPACEBAR_TO_SPIN_ENABLED,
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.SPACEBAR_TO_SPIN_DISABLED
            ...
            },
            {
              ...
              value: function _handleCustomEvent(eventData) {
                if (
                  eventData.action === "Buy bonus popup closed" &&
                  eventData.label === "Bonus not purchased"
                ) {
                  this.sendAction(
                    _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                      .AnalyticsAction.BUY_BONUS_SCREEN_CLOSED
            ...
            },
            {
              ...
              value: function _handleSkinChange(targetSkin, source) {
                ...
                var currentSkin =
                  ((_window$__OPTIONS__8 = window.__OPTIONS__) === null ||
                  _window$__OPTIONS__8 === void 0 ||
                  (_window$__OPTIONS__8 = _window$__OPTIONS__8.ui) === null ||
                  _window$__OPTIONS__8 === void 0
                    ? void 0
                    : _window$__OPTIONS__8.applied_skin) ||
                  ((_window$__OPTIONS__9 = window.__OPTIONS__) === null ||
                  _window$__OPTIONS__9 === void 0 ||
                  (_window$__OPTIONS__9 = _window$__OPTIONS__9.ui) === null ||
                  _window$__OPTIONS__9 === void 0
                    ? void 0
                    : _window$__OPTIONS__9.skin);
                var data = {
            ...
            },
            {
              ...
              value: function _handleLinesCountChange(targetLinesCount) {
                var currentLinesCount =
                  this.userProperties.get("Lines Count Mode");
                var data = {
                ...
                this.sendAction(
                  _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                    .AnalyticsAction.LINES_COUNT_SWITCHED,
                  data,
                  true
                );
              },
            },
            {
              ...
              value: function _handleVolatilityChange(volatility, source) {
                ...
                this.sendAction(
                  _common_AnalyticsAction__WEBPACK_IMPORTED_MODULE_1__
                    .AnalyticsAction.VOLATILITY_SWITCHED,
                  data,
                  true
                );
              },
            },
            {
              ...
              value: function _scheduleOptionsTrack(
                optionsKey,
                actionOn,
                actionOff,
                actionData
            ...
            },
            {
              ...
              value: function _checkFeatures(spinData) {
                var _spinData$gameFlow3,
                  _spinData$gameFlow4,
                  _spinData$gameFlow5;
                var activeFeatureName =
                  (_spinData$gameFlow3 = spinData.gameFlow) === null ||
                  _spinData$gameFlow3 === void 0 ||
                  (_spinData$gameFlow3 =
                    _spinData$gameFlow3.purchased_feature) === null ||
                  _spinData$gameFlow3 === void 0
                    ? void 0
                    : _spinData$gameFlow3.name;
                var command =
                  (_spinData$gameFlow4 = spinData.gameFlow) === null ||
                  _spinData$gameFlow4 === void 0
                    ? void 0
                    : _spinData$gameFlow4.command;
                var state =
                  (_spinData$gameFlow5 = spinData.gameFlow) === null ||
                  _spinData$gameFlow5 === void 0
                    ? void 0
                    : _spinData$gameFlow5.state;
                var isPurchasedRoundFinished =
                  activeFeatureName &&
                  this.finishStates.includes(state) &&
                  this.buyFeatures.includes(activeFeatureName);
                var isFeatureStarted =
                  !activeFeatureName &&
                  command === "spin" &&
                  this.gameFeatures.states.includes(state);
                var isFeatureFinished =
                  !activeFeatureName &&
                  this.gameFeatures.commands.includes(command) &&
                  this.finishStates.includes(state);
                return {
    ...
    "./src/tracker/RudderStackGameTracker.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */
        var _rudderstack_analytics_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! @rudderstack/analytics-js */ "../../node_modules/@rudderstack/analytics-js/dist/npm/modern/esm/index.mjs"
          );
        /* harmony import */
        var _roundSeriesId__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ./roundSeriesId */ "./src/tracker/roundSeriesId.js"
        );
        /* harmony import */
        var _common_const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../common/const */ "./src/common/const.js"
        );
        ...
        var RudderStackGameTracker = /*#__PURE__*/ (function () {
          function RudderStackGameTracker() {
            ...
            _defineProperty(
              this,
              "analytics",
              new _rudderstack_analytics_js__WEBPACK_IMPORTED_MODULE_0__.RudderAnalytics()
            );
            this.load();
          }
          return _createClass(RudderStackGameTracker, [
            {
              ...
              value: function load() {
                this.analytics.load(
                  _common_const__WEBPACK_IMPORTED_MODULE_2__.RUDDERSTACK_TRACK_ID,
                  _common_const__WEBPACK_IMPORTED_MODULE_2__.RUDDERSTACK_API_URL,
                  {
                    integrations: {
                      All: false,
                    },
                ...
                (0,
                _roundSeriesId__WEBPACK_IMPORTED_MODULE_1__.initializePlayerId)();
                (0,
                _roundSeriesId__WEBPACK_IMPORTED_MODULE_1__.createNewRoundSeriesId)();
              },
            },
            {
              key: "track",
    ...
    "./src/tracker/roundSeriesId.js":
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        __webpack_require__.d(__webpack_exports__, {
          /* harmony export */
          clearRoundSeriesRefreshFlag: () =>
            /* binding */ clearRoundSeriesRefreshFlag,
          /* harmony export */
          ...
          /* harmony export */
          requestRoundSeriesRefresh: () =>
            /* binding */ requestRoundSeriesRefresh,
          /* harmony export */
        });
        ...
        var initializePlayerId = function initializePlayerId() {
          ...
          var loyaltyOptions =
            options === null || options === void 0
              ? void 0
              : options.lobby_v2_options;
          if (
            loyaltyOptions !== null &&
            loyaltyOptions !== void 0 &&
            loyaltyOptions.player_id
          ) {
            roundSeriesState.playerId = loyaltyOptions.player_id;
          } else {
            console.warn(
              "Can't find player_id in window.__OPTIONS__.lobby_v2_options"
            );
        ...
        var clearRoundSeriesRefreshFlag =
          function clearRoundSeriesRefreshFlag() {
      ...
      (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        __webpack_require__.d(__webpack_exports__, {
          ...
          disconnectGlobalObserver: () =>
            /* binding */ disconnectGlobalObserver,
          /* harmony export */
        ...
        function _loadDOMNodes(_ref) {
          ...
          var insertBeforeNode = insertBeforeSelector
        ...
        var getAttrValue = function getAttrValue(attrName) {
          return function (el) {
            ...
            return (_el$getAttribute = el.getAttribute(attrName)) != null
              ? _el$getAttribute
              : null;
          };
        };
        ...
        function deleteElementPropertyRecord(el, attr) {
          ...
          if (attr === "html") {
            ...
            (_element$html = element.html) == null
              ? void 0
              : (_element$html$observe = _element$html.observer) == null
              ? void 0
              : _element$html$observe.disconnect();
            delete element.html;
          } else if (attr === "class") {
            var _element$classes, _element$classes$obse;

            (_element$classes = element.classes) == null
              ? void 0
              : (_element$classes$obse = _element$classes.observer) == null
              ? void 0
              : _element$classes$obse.disconnect();
            delete element.classes;
          } else if (attr === "position") {
            var _element$position, _element$position$obs;

            (_element$position = element.position) == null
              ? void 0
              : (_element$position$obs = _element$position.observer) == null
              ? void 0
              : _element$position$obs.disconnect();
            delete element.position;
          } else {
            var _element$attributes,
              _element$attributes$a,
              _element$attributes$a2;

            (_element$attributes = element.attributes) == null
              ? void 0
              : (_element$attributes$a = _element$attributes[attr]) == null
              ? void 0
              : (_element$attributes$a2 = _element$attributes$a.observer) ==
                null
              ? void 0
              : _element$attributes$a2.disconnect();
    ...
    "../../node_modules/@rudderstack/analytics-js/dist/npm/modern/esm/index.mjs":
      ...
      (
         ...
         */
        var mergeWithKey = /*#__PURE__*/ _curry3(function mergeWithKey(
          fn,
          l,
          r
        ) {
         ...
         */
        var mergeDeepWithKey = /*#__PURE__*/ _curry3(function mergeDeepWithKey(
          fn,
          lObj,
          rObj
        ) {
         ...
         */
        var mergeDeepWith = /*#__PURE__*/ _curry3(function mergeDeepWith(
          fn,
          lObj,
          rObj
        ) {
         ...
         * @returns boolean
         */
        const isDefinedNotNullAndNotEmptyString = (value) =>
        ...
        const mergeDeepRightObjectArrays = (leftValue, rightValue) => {
          ...
          rightValue.forEach((value, index) => {
            mergedArray[index] =
              Array.isArray(value) || isObjectAndNotNull(value) // eslint-disable-next-line @typescript-eslint/no-use-before-define
        ...
        const pageArgumentsToCallOptions = (
          ...
          const nameForProperties = isString(payload.name)
            ? payload.name
            : payload.properties.name;
          const categoryForProperties = isString(payload.category)
            ? payload.category
            : payload.properties.category; // add name and category to properties
          payload.properties = mergeDeepRight(
            isObjectLiteralAndNotNull(payload.properties)
              ? payload.properties
              : {},
            {
              ...(nameForProperties && {
        ...
        const trackArgumentsToCallOptions = (
          ...
          // and set some proper defaults
          // Also, to clone the incoming object type arguments
          payload.properties = isDefinedAndNotNull(payload.properties)
            ? clone(payload.properties)
            : {};
          if (isDefined(payload.options)) {
            payload.options = clone(payload.options);
         ...
         */
        let PageLifecycleEvents = /*#__PURE__*/ (function (
          PageLifecycleEvents
        ) {
        ...
        const hasCrypto$1 = () =>
          !isNullOrUndefined(globalThis.crypto) &&
          isFunction(globalThis.crypto.getRandomValues);
        ...
        const stringifyWithoutCircular = (
          ...
          try {
            return JSON.stringify(
              value,
              getCircularReplacer(excludeNull, excludeKeys, logger)
            );
          } catch (err) {
        ...
        const traverseWithThis = (obj, replacer) => {
          ...
          for (const key in obj) {
            if (Object.hasOwnProperty.call(obj, key)) {
              ...
              if (
                isObjectLiteralAndNotNull(sanitizedValue) ||
        ...
        const getMutatedError = (err, issue) => {
          ...
          if (!isTypeOfError(err)) {
            finalError = new Error(
              `${issue}: ${stringifyWithoutCircular(err)}`
            );
          } else {
        ...
        const retrieveEventsFromQueryString = (argumentsArray = []) => {
          ...
          if (queryObject.get(QUERY_PARAM_TRACK_EVENT_NAME_KEY)) {
            argumentsArray.unshift([
              ...
              getEventDataFromQueryString(
                queryObject,
                eventArgumentToQueryParamMap.properties
              ),
            ]);
          ...
          if (queryObject.get(QUERY_PARAM_USER_ID_KEY)) {
            argumentsArray.unshift([
              ...
              getEventDataFromQueryString(
                queryObject,
                eventArgumentToQueryParamMap.trait
              ),
            ]);
          } // Set anonymousID
          if (queryObject.get(QUERY_PARAM_ANONYMOUS_ID_KEY)) {
            argumentsArray.unshift([
              "setAnonymousId",
              queryObject.get(QUERY_PARAM_ANONYMOUS_ID_KEY),
            ]);
          }
        };
        /**
        ...
        const getPreloadedLoadEvent = (preloadedEventsArray) => {
          ...
          while (i < preloadedEventsArray.length) {
            if (
              ...
              preloadedEventsArray[i][0] === loadMethodName
            ) {
        ...
        const retrievePreloadBufferEvents = (instance) => {
          const preloadedEventsArray =
            getExposedGlobal(GLOBAL_PRELOAD_BUFFER) || []; // Get events that are pre-populated via query string params
        ...
        const createScriptElement = (
          ...
          Object.keys(extraAttributes).forEach((attributeName) => {
            scriptElement.setAttribute(
              attributeName,
              extraAttributes[attributeName]
            );
          });
          scriptElement.setAttribute(
            "data-loader",
            EXTERNAL_SOURCE_LOAD_ORIGIN
          );
        ...
        class ExternalSrcLoader {
           ...
           */
          loadJSFile(config) {
            const { url, id, timeout, async, callback, extraAttributes } =
              config;
        ...
        class Logger {
          ...
          outputLog(logMethod, data) {
            if (this.minLogLevel <= LOG_LEVEL_MAP[logMethod]) {
              this.logProvider[logMethod.toLowerCase()]?.(
        ...
        const COMPONENT_BASE_URL_ERROR = (component) =>
          `Failed to load the SDK as the base URL for ${component} is not valid.`; // ERROR
        ...
        const SOURCE_CONFIG_FETCH_ERROR = (reason) =>
          `Failed to fetch the source config. Reason: ${reason}`;
        const WRITE_KEY_VALIDATION_ERROR = (context, writeKey) =>
        ...
        const DATA_PLANE_URL_VALIDATION_ERROR = (context, dataPlaneUrl) =>
        ...
        const generateMisconfiguredPluginsWarning = (
          ...
          if (shouldAddMissingPlugins) {
            return `${baseWarning} So, ${
              isSinglePlugin ? "the plugin" : "those plugins"
            } will be loaded automatically.`;
          }
          return `${baseWarning} Ignore if this was intentional. Otherwise, consider adding ${
            isSinglePlugin ? "it" : "them"
          } to the 'plugins' load API option.`;
        };
        const INVALID_POLYFILL_URL_WARNING = (context, customPolyfillUrl) =>
        ...
        const PAGE_UNLOAD_ON_BEACON_DISABLED_WARNING = (context) =>
        ...
        class PluginEngine {
          ...
          register(plugin, state) {
            ...
            if (this.byName[plugin.name]) {
              const errorMessage = PLUGIN_ALREADY_EXISTS_ERROR(
                PLUGIN_ENGINE,
                plugin.name
              );
              if (this.config.throws) {
          ...
          getPlugins(extPoint) {
            ...
            if (!this.cache[lifeCycleName]) {
              this.cache[lifeCycleName] = this.plugins.filter((plugin) => {
                if (
                  plugin.deps?.some((dependency) => !this.byName[dependency])
                ) {
                  // If deps not exist, then not load it.
                  const notExistDeps = plugin.deps.filter(
                    (dependency) => !this.byName[dependency]
                  );
                  this.logger?.error(
                    PLUGIN_DEPS_ERROR(PLUGIN_ENGINE, plugin.name, notExistDeps)
                  );
                  return false;
                }
                return lifeCycleName === "."
                  ? true
                  : hasValueByPath(plugin, lifeCycleName);
              });
            }
          ...
          invoke(extPoint, allowMultiple = true, ...args) {
            ...
            const throws =
              this.config.throws ?? extensionPointName.endsWith("!"); // eslint-disable-next-line unicorn/better-regex
            ...
            return pluginsToInvoke.map((plugin) => {
              ...
              try {
                return method.apply(
                  getValueByPath(plugin, pluginMethodPath),
                  args
                );
              } catch (err) {
        ...
        const processError = (error) => {
          ...
          try {
            if (isString(error)) {
              ...
              errorMessage = error.message
                ? error.message
                : stringifyWithoutCircular(error);
            }
          } catch (e) {
        ...
        class ErrorHandler {
            ...
            try {
              ...
              if (errReportingInitVal instanceof Promise) {
                errReportingInitVal
                  ...
                  .catch((err) => {
                    this.logger?.error(
                      REPORTING_PLUGIN_INIT_FAILURE_ERROR(ERROR_HANDLER),
                      err
                    );
                  });
              }
          ...
          onError(
            ...
            const isErrorReportingPluginLoaded =
         ...
         * @returns boolean
         */
        const isNonCloudDestination = (destination) =>
          Boolean(
         ...
         */
        const getNonCloudDestinations = (destinations) =>
        ...
        class PluginsManager {
          ...
          init() {
            ...
            // remote plugin cdn path to support proxied plugin remotes
            {
              setExposedGlobal(
                "pluginsCDNPath",
                state.lifecycle.pluginsCDNPath.value
              );
            }
          ...
          attachEffects() {
            E(() => {
              const isAllPluginsReady =
                ...
                state.plugins.loadedPlugins.value.length +
                  state.plugins.failedPlugins.value.length ===
          ...
          getPluginsToLoadBasedOnConfig() {
            ...
            const pluginGroupsToProcess = [
              {
                configurationStatus: () =>
                  isDefined(state.dataPlaneEvents.eventsQueuePluginName.value),
                configurationStatusStr: "Data plane events delivery is enabled",
                activePluginName:
                  state.dataPlaneEvents.eventsQueuePluginName.value,
                supportedPlugins: Object.values(
              ...
              },
              {
                configurationStatus: () =>
                  getNonCloudDestinations(
                    ...
                    (destination) =>
                      destination.shouldApplyDeviceModeTransformation
                  ),
                configurationStatusStr:
              ...
              {
                configurationStatus: () =>
                  isDefined(state.storage.encryptionPluginName.value),
          ...
          addMissingPlugins(group, addMissingPlugins, pluginsToLoadFromConfig) {
            const shouldAddMissingPlugins =
              group.shouldAddMissingPlugins || addMissingPlugins;
              ...
              Object.keys(remotePluginsList).map(async (remotePluginKey) => {
                await remotePluginsList[remotePluginKey]()
                  .then((remotePluginModule) =>
                    this.register([remotePluginModule.default()])
                  )
                  .catch((err) => {
        ...
        const createXhrRequestOptions = (url, options, basicAuthHeader) => {
          const requestOptions = mergeDeepRight(
        ...
        const xhrRequest = (
          ...
          new Promise((resolve, reject) => {
            ...
            if (options.sendRawData === true) {
              ...
              payload = stringifyWithoutCircular(
                options.data,
                false,
                [],
                logger
            ...
            try {
              ...
              reject({
                error: getMutatedError(
                  err,
                  XHR_SEND_ERROR(FAILED_REQUEST_ERR_MSG_PREFIX, options.url)
                ),
                xhr,
                options,
              });
          ...
          async getData(config) {
            ...
            try {
              ...
              return {
                data: isRawResponse
                  ? data.response
                  : responseTextToJson(data.response, this.onError),
                details: data,
              };
            } catch (reason) {
        ...
        const hasCrypto = () =>
          !isNullOrUndefined(globalThis.crypto) &&
          isFunction(globalThis.crypto.getRandomValues); // eslint-disable-next-line compat/compat -- We are checking for the existence of navigator.userAgentData
        const hasUAClientHints = () =>
          !isNullOrUndefined(globalThis.navigator.userAgentData);
        const hasBeacon = () =>
          !isNullOrUndefined(globalThis.navigator.sendBeacon) &&
          isFunction(globalThis.navigator.sendBeacon);
        const isIE11 = () =>
          Boolean(globalThis.navigator.userAgent.match(/Trident.*rv:11\./));
        ...
        const legacyJSEngineRequiredPolyfills = {
          ...
          URL: () =>
            !isFunction(globalThis.URL) ||
            !isFunction(globalThis.URLSearchParams),
          ...
          "Array.prototype.find": () =>
            !isFunction(globalThis.Array.prototype.find),
          "Array.prototype.includes": () =>
            !isFunction(globalThis.Array.prototype.includes),
          "String.prototype.endsWith": () =>
            !isFunction(globalThis.String.prototype.endsWith),
          "String.prototype.startsWith": () =>
            !isFunction(globalThis.String.prototype.startsWith),
          "String.prototype.includes": () =>
            !isFunction(globalThis.String.prototype.includes),
          "String.prototype.replaceAll": () =>
            !isFunction(globalThis.String.prototype.replaceAll),
          "String.fromCodePoint": () =>
            !isFunction(globalThis.String.fromCodePoint),
          ...
          "Object.fromEntries": () =>
            !isFunction(globalThis.Object.fromEntries),
          ...
          TextEncoder: () =>
            !isFunction(globalThis.TextEncoder) ||
            !isFunction(globalThis.TextDecoder),
          requestAnimationFrame: () =>
            !isFunction(globalThis.requestAnimationFrame) ||
            !isFunction(globalThis.cancelAnimationFrame),
          CustomEvent: () => !isFunction(globalThis.CustomEvent),
          "navigator.sendBeacon": () =>
            !isFunction(globalThis.navigator.sendBeacon), // Note, the polyfill service serves both ArrayBuffer and Uint8Array under the same feature name, "ArrayBuffer".
        ...
        const isLegacyJSEngine = () => {
          const requiredCapabilitiesList = Object.keys(
          ...
          for (let i = 0; i < requiredCapabilitiesList.length; i++) {
            const isCapabilityMissing =
              legacyJSEngineRequiredPolyfills[requiredCapabilitiesList[i]];
        ...
        const isStorageQuotaExceeded = (e) => {
          ...
          const isQuotaExceededError =
            matchingNames.includes(e.name) || matchingCodes.includes(e.code);
              ...
              function dealIncognito(storage) {
                ...
                try {
                  ...
                  inMemoryStorage.getItem = function (id) {
                    return inMemoryStorage._data.hasOwnProperty(id)
                      ? inMemoryStorage._data[id]
                      : undefined;
                  };
        ...
        const configureCookieStorageEngine = (options) => {
          const cookieStorageOptions = new CookieStorage(
            {},
            defaultLogger
          ).configure(options);
        ...
        class Store {
           ...
           */
          createValidKey(key) {
            const { name, id, validKeys, noKeyValidation, noCompoundKey } =
              this;
            if (noKeyValidation) {
          ...
          set(key, value) {
            ...
            try {
              ...
              if (isStorageQuotaExceeded(err)) {
                this.logger?.warn(
                  STORAGE_QUOTA_EXCEEDED_WARNING(`Store ${this.id}`)
          ...
          get(key) {
            ...
            try {
              ...
              this.onError(
                new Error(`${STORE_DATA_FETCH_ERROR(key)}: ${err.message}`)
              ); // A hack for warning the users of potential partial SDK version migrations
              if (
                isString(decryptedValue) &&
                decryptedValue.startsWith("RudderEncrypt:")
              ) {
        ...
        class StoreManager {
          ...
          initializeStorageState() {
            ...
            const postConsentStorageOpts =
              state.consents.postConsent.value.storage;
            if (
              isDefined(postConsentStorageOpts?.type) ||
              isDefined(postConsentStorageOpts?.entries)
            ) {
            ...
            USER_SESSION_KEYS.forEach((sessionKey) => {
              ...
              const preConsentStorageType =
                getStorageTypeFromPreConsentIfApplicable(state, sessionKey); // Storage type precedence order: pre-consent strategy > entry type > global type > default
              const storageType =
                preConsentStorageType ??
                configuredStorageType ??
                globalStorageType ??
                DEFAULT_STORAGE_TYPE;
              const finalStorageType = this.getResolvedStorageTypeForEntry(
                storageType,
                sessionKey
              );
            ...
            r(() => {
              ...
              state.storage.trulyAnonymousTracking.value =
          ...
          setStore(storeConfig) {
            ...
            this.stores[storeConfig.id] = new Store(
              storeConfig,
              storageEngine,
              this.pluginsManager
            );
        ...
        const isValidStorageType = (storageType) =>
          ...
          SUPPORTED_STORAGE_TYPES.includes(storageType);
        ...
        const getDataServiceUrl = (endpoint, useExactDomain) => {
          const url = useExactDomain
            ? window.location.origin
            : getTopDomainUrl(window.location.href);
          ...
          destinations.forEach((destination) => {
            if (destination.enabled && !destination.deleted) {
              nativeDestinations.push({
                ...
                userFriendlyId: `${destination.destinationDefinition.displayName.replaceAll(
                  " ",
                  "-"
                )}___${destination.id}`,
              });
        ...
        const getValidPostConsentOptions = (options) => {
          ...
          if (isObjectLiteralAndNotNull(options)) {
            ...
            validOptions.discardPreConsentEvents =
              clonedOptions.discardPreConsentEvents === true;
            ...
            if (isNonEmptyObject(clonedOptions.consentManagement)) {
              ...
              validOptions.consentManagement = mergeDeepRight(
                clonedOptions.consentManagement,
                {
         ...
         */
        const isValidConsentsData = (value) =>
        ...
        const getConsentManagerInfo = (consentManagementOpts, logger) => {
          let { provider } = consentManagementOpts;
          const consentManagerPluginName = provider
            ? ConsentManagersToPluginNameMap[provider]
            : undefined;
        ...
        const getConsentManagementData = (consentManagementOpts, logger) => {
          ...
          if (isNonEmptyObject(consentManagementOpts) && enabled) {
            ...
            ({ provider, consentManagerPluginName } = getConsentManagerInfo(
        ...
        const updateReportingState = (res) => {
          state.reporting.isErrorReportingEnabled.value =
            isErrorReportingEnabled(res.source.config) &&
            !isSDKRunningInChromeExtension();
          state.reporting.isMetricsReportingEnabled.value =
            isMetricsReportingEnabled(res.source.config);
        };
        const getServerSideCookiesStateData = (logger) => {
          ...
          if (useServerSideCookies) {
            ...
            const providedCookieDomain =
              cookieOptions.domain ?? setCookieDomain;
            /**
            ...
            const useExactDomain =
              (isDefined(providedCookieDomain) &&
                !isWebpageTopLevelDomain(
                  removeLeadingPeriod(providedCookieDomain)
                )) ||
              sameDomainCookiesOnly;
            ...
            if (isValidURL(dataServiceUrl)) {
              ...
              if (
                !sameDomainCookiesOnly &&
                useExactDomain &&
                dataServiceHost !== removeLeadingPeriod(providedCookieDomain)
              ) {
                sscEnabled = false;
                logger?.warn(
        ...
        const updateStorageStateFromLoadOptions = (logger) => {
          ...
          let storageEncryptionVersion =
            storageOptsFromLoad?.encryption?.version;
          const encryptionPluginName =
            storageEncryptionVersion &&
            StorageEncryptionVersionsToPluginNameMap[storageEncryptionVersion];
          if (
            !isUndefined(storageEncryptionVersion) &&
            isUndefined(encryptionPluginName)
          ) {
          ...
          if (
            ...
            finalMigrationVal !== configuredMigrationValue
          ) {
            logger?.warn(
          ...
          const { sscEnabled, finalDataServiceUrl, cookieOptions } =
        ...
        const updateConsentsStateFromLoadOptions = (logger) => {
          ...
          if (
            ...
            !StorageStrategies.includes(storageStrategy)
          ) {
          ...
          if (
            ...
            !deliveryTypes.includes(eventsDeliveryType)
          ) {
        ...
        const getSourceConfigURL = (
          ...
          if (isValidURL(configUrl)) {
            ...
            if (
              !removeTrailingSlashes(configUrlInstance.pathname).endsWith(
                "/sourceConfig"
              )
            ) {
            ...
            configUrlInstance.pathname = removeDuplicateSlashes(
              configUrlInstance.pathname
            );
        ...
        class ConfigManager {
          ...
          processConfig(response, details) {
            ...
            if (!isValidSourceConfig(res)) {
              this.onError(
                new Error(SOURCE_CONFIG_RESOLUTION_ERROR),
                undefined,
                true
              );
              return;
            ...
            const nativeDestinations =
              res.source.destinations.length > 0
                ? filterEnabledDestination(res.source.destinations)
            ...
            r(() => {
              ...
              state.nativeDestinations.configuredDestinations.value =
                nativeDestinations; // set the desired optional plugins
              state.plugins.pluginsToLoadFromConfig.value =
                state.loadOptions.value.plugins ?? [];
        ...
        const getUserAgent = () => {
          ...
          const { brave } = globalThis.navigator; // For supporting Brave browser detection,
        ...
        const getDefaultPageProperties = () => {
          ...
          let pageUrl = tabUrl;
          const { search } = globalThis.location; // If valid canonical URL is provided use this as page URL.
          if (canonicalUrl) {
            try {
        ...
        const POLYFILL_URL = `https://polyfill-fastly.io/v3/polyfill.min.js?version=3.111.0&features=${Object.keys(
          legacyJSEngineRequiredPolyfills
        ).join("%2C")}`;
        ...
        class CapabilitiesManager {
          ...
          detectBrowserCapabilities() {
            r(() => {
              ...
              state.capabilities.storage.isCookieStorageAvailable.value =
                isStorageAvailable(
                  COOKIE_STORAGE,
                  getStorageEngine(COOKIE_STORAGE),
                  this.logger
                );
              state.capabilities.storage.isLocalStorageAvailable.value =
                isStorageAvailable(LOCAL_STORAGE, undefined, this.logger);
              state.capabilities.storage.isSessionStorageAvailable.value =
                isStorageAvailable(SESSION_STORAGE, undefined, this.logger); // Browser feature detection details
          ...
          prepareBrowserCapabilities() {
            ...
            if (shouldLoadPolyfill) {
              const isDefaultPolyfillService =
        ...
        const CONTEXT_RESERVED_ELEMENTS = [
          "library",
          "consentManagement",
          "userAgent",
          "ua-ch",
         ...
         * @returns boolean
         */
        const hasMinLength = (minimumLength, num) =>
          num.toString().length >= minimumLength;
        /**
        ...
        const generateManualTrackingSession = (id, logger) => {
          const sessionId = isManualSessionIdValid(id, logger)
            ? id
            : generateSessionId();
          return {
            id: sessionId,
        ...
        const getUpdatedPageProperties = (properties, options) => {
          ...
          if (isUndefined(pageProps.initial_referrer)) {
            pageProps.initial_referrer =
              optionsPageProps.initial_referrer ||
        ...
        const updateTopLevelEventElements = (rudderEvent, options) => {
          ...
          if (
            ...
            isString(options.originalTimestamp)
          ) {
            // eslint-disable-next-line no-param-reassign
        ...
        const getMergedContext = (rudderContext, options, logger) => {
          ...
          Object.keys(options).forEach((key) => {
            if (
              !TOP_LEVEL_ELEMENTS.includes(key) &&
              !CONTEXT_RESERVED_ELEMENTS.includes(key)
            ) {
              if (key !== "context") {
                ...
                isObjectLiteralAndNotNull(options[key])
              ) {
                const tempContext = {};
        ...
        const processOptions = (rudderEvent, options) => {
          ...
          if (isObjectLiteralAndNotNull(options)) {
            ...
            rudderEvent.context = getMergedContext(
              rudderEvent.context,
              options
            );
          }
        ...
        const getEnrichedEvent = (rudderEvent, options, pageProps, logger) => {
          const commonEventData = {
            ...
            context: {
              ...
              sessionStart:
                state.session.sessionInfo.value.sessionStart || undefined, // Add 'consentManagement' only if consent management is enabled
              ...(state.consents.enabled.value && {
                consentManagement: {
                  deniedConsentIds: clone(
                    state.consents.data.value.deniedConsentIds
                  ),
                  allowedConsentIds: clone(
          ...
          if (
            !isStorageTypeValidForStoringData(
              state.storage.entries.value.anonymousId?.type
            )
          ) {
          ...
          if (rudderEvent.type === "group") {
            if (rudderEvent.groupId || state.session.groupId.value) {
              commonEventData.groupId =
                rudderEvent.groupId || state.session.groupId.value;
            }
          ...
          processedEvent.integrations = getEventIntegrationsConfig(
            processedEvent.integrations
          );
        ...
        class UserSessionManager {
          ...
          syncStorageDataToState() {
            ...
            const { externalAnonymousIdCookieName, anonymousIdOptions } =
              state.loadOptions.value;
            ...
            this.setAnonymousId(
              externalAnonymousId ?? this.getAnonymousId(anonymousIdOptions)
            );
          ...
          configureSessionTracking() {
            ...
            if (this.isPersistenceEnabledForStorageEntry("sessionInfo")) {
              const configuredSessionTrackingInfo =
                this.getConfiguredSessionTrackingInfo();
              const initialSessionInfo =
                sessionInfo ?? defaultSessionConfiguration;
              sessionInfo = {
                ...initialSessionInfo,
                ...configuredSessionTrackingInfo, // If manualTrack is set to true in the storage, then autoTrack should be false
                autoTrack:
                  configuredSessionTrackingInfo.autoTrack &&
                  initialSessionInfo.manualTrack !== true,
          ...
          setInitialReferrerInfo() {
            ...
            const persistedInitialReferringDomain =
              this.getInitialReferringDomain();
            if (persistedInitialReferrer && persistedInitialReferringDomain) {
              ...
              this.setInitialReferringDomain(
          ...
          isPersistenceEnabledForStorageEntry(entryName) {
            return isStorageTypeValidForStoringData(
              state.storage.entries.value[entryName]?.type
            );
          }
          migrateDataFromPreviousStorage() {
            const entries = state.storage.entries.value;
            const storageTypesForMigration = [
              COOKIE_STORAGE,
              LOCAL_STORAGE,
              SESSION_STORAGE,
            ];
            Object.keys(entries).forEach((entry) => {
              ...
              const curStore = this.storeManager?.getStore(
                storageClientDataStoreNameMap[currentStorage]
              );
              if (curStore) {
                storageTypesForMigration.forEach((storage) => {
                  const store = this.storeManager?.getStore(
                    storageClientDataStoreNameMap[storage]
                  );
          ...
          getConfiguredSessionTrackingInfo() {
            let autoTrack =
              state.loadOptions.value.sessions?.autoTrack !== false; // Do not validate any further if autoTrack is disabled
            if (!autoTrack) {
              return {
                autoTrack,
              };
            ...
            let timeout;
            const configuredSessionTimeout =
              state.loadOptions.value.sessions?.timeout;
          ...
          setServerSideCookies(cookiesData, cb, store) {
            try {
              ...
              if (encryptedCookieData.length > 0) {
                ...
                this.makeRequestToSetCookie(
                  encryptedCookieData,
                  (res, details) => {
                    if (details?.xhr?.status === 200) {
                      cookiesData.forEach((cData) => {
                        const cookieValue = store?.get(cData.name);
                        const before = stringifyWithoutCircular(
                          cData.value,
                          false,
                          []
                        );
                        const after = stringifyWithoutCircular(
                          cookieValue,
                          false,
                          []
                        );
                        if (after !== before) {
                          this.logger?.error(
                            FAILED_SETTING_COOKIE_FROM_SERVER_ERROR(cData.name)
                          );
                          if (cb) {
                      ...
                      this.logger?.error(
                        DATA_SERVER_REQUEST_FAIL_ERROR(details?.xhr?.status)
                      );
          ...
          syncValueToStorage(sessionKey, value) {
            ...
            if (isStorageTypeValidForStoringData(storageType)) {
              const curStore = this.storeManager?.getStore(
                storageClientDataStoreNameMap[storageType]
              );
          ...
          getAnonymousId(options) {
            ...
            if (isStorageTypeValidForStoringData(storage)) {
              ...
              state.session.anonymousId.value =
                persistedAnonymousId || generateAnonymousId();
            }
          ...
          getSessionId() {
            const sessionInfo =
              this.getSessionInfo() ?? DEFAULT_USER_SESSION_VALUES.sessionInfo;
            if (
              (sessionInfo.autoTrack &&
                !hasSessionExpired(sessionInfo.expiresAt)) ||
          ...
          setUserTraits(traits) {
            state.session.userTraits.value =
              this.isPersistenceEnabledForStorageEntry("userTraits") &&
          ...
          setGroupTraits(traits) {
            state.session.groupTraits.value =
              this.isPersistenceEnabledForStorageEntry("groupTraits") &&
              isObjectLiteralAndNotNull(traits)
                ? mergeDeepRight(
                    state.session.groupTraits.value ??
                      DEFAULT_USER_SESSION_VALUES.groupTraits,
          ...
          setInitialReferrer(referrer) {
            state.session.initialReferrer.value =
              this.isPersistenceEnabledForStorageEntry("initialReferrer") &&
              referrer
                ? referrer
           ...
           */
          start(id) {
            state.session.sessionInfo.value = generateManualTrackingSession(
              id,
              this.logger
            );
          }
         ...
         */
        const defaultOptionalPluginsList = [
          "BeaconQueue",
          "Bugsnag",
          "CustomConsentManager",
          "DeviceModeDestinations",
        ...
        const normalizeLoadOptions = (loadOptionsFromState, loadOptions) => {
          ...
          if (
            !cookieSameSiteValues.includes(normalizedLoadOpts.sameSiteCookie)
          ) {
            delete normalizedLoadOpts.sameSiteCookie;
          }
          normalizedLoadOpts.secureCookie =
            normalizedLoadOpts.secureCookie === true;
          normalizedLoadOpts.sameDomainCookiesOnly =
            normalizedLoadOpts.sameDomainCookiesOnly === true;
          ...
          normalizedLoadOpts.sendAdblockPage =
            normalizedLoadOpts.sendAdblockPage === true;
          normalizedLoadOpts.useServerSideCookies =
            normalizedLoadOpts.useServerSideCookies === true;
          if (
          ...
          if (!isDefined(normalizedLoadOpts.loadIntegration)) {
            ...
            normalizedLoadOpts.loadIntegration =
              normalizedLoadOpts.loadIntegration === true;
          }
          if (!isObjectLiteralAndNotNull(normalizedLoadOpts.storage)) {
            delete normalizedLoadOpts.storage;
          } else {
            normalizedLoadOpts.storage = removeUndefinedAndNullValues(
          ...
          if (
            !isObjectLiteralAndNotNull(normalizedLoadOpts.beaconQueueOptions)
          ) {
          ...
          if (!isObjectLiteralAndNotNull(normalizedLoadOpts.queueOptions)) {
            ...
            normalizedLoadOpts.queueOptions = removeUndefinedAndNullValues(
              normalizedLoadOpts.queueOptions
            );
          }
          normalizedLoadOpts.lockIntegrationsVersion =
            normalizedLoadOpts.lockIntegrationsVersion === true;
          normalizedLoadOpts.lockPluginsVersion =
            normalizedLoadOpts.lockPluginsVersion === true;
          ...
          if (!isObjectLiteralAndNotNull(normalizedLoadOpts.preConsent)) {
            ...
            normalizedLoadOpts.preConsent = removeUndefinedAndNullValues(
              normalizedLoadOpts.preConsent
            );
          }
          const mergedLoadOptions = mergeDeepRight(
        ...
        const getFinalEvent = (event, state) => {
          ...
          const destinationsIntgConfig =
            state.nativeDestinations.integrationsConfig.value;
          const overriddenIntgOpts = getOverriddenIntegrationOptions(
            event.integrations,
            destinationsIntgConfig
          );
          finalEvent.integrations = mergeDeepRight(
            destinationsIntgConfig,
            overriddenIntgOpts
          );
          return finalEvent;
        };
        const shouldBufferEventsForPreConsent = (state) =>
        ...
        class EventRepository {
          ...
          init() {
            ...
            const bufferEventsBeforeConsent =
              shouldBufferEventsForPreConsent(state); // Start the queue processing only when the destinations are ready or hybrid mode destinations exist
            ...
            E(() => {
              const shouldBufferDpEvents =
                state.loadOptions.value.bufferDataPlaneEventsUntilReady ===
                  true &&
                state.nativeDestinations.clientDestinationsReady.value ===
                  false;
              const hybridDestExist =
                state.nativeDestinations.activeDestinations.value.some((dest) =>
        ...
        const isWriteKeyValid = (writeKey) =>
          isString(writeKey) && writeKey.trim().length > 0;
        ...
        class Analytics {
          ...
          load(writeKey, dataPlaneUrl, loadOptions = {}) {
            ...
            if (!isWriteKeyValid(writeKey)) {
              this.logger.error(
                WRITE_KEY_VALIDATION_ERROR(ANALYTICS_CORE, writeKey)
              );
              return;
            }
            if (!isDataPlaneUrlValid(dataPlaneUrl)) {
              this.logger.error(
                DATA_PLANE_URL_VALIDATION_ERROR(ANALYTICS_CORE, dataPlaneUrl)
              );
              return;
            ...
            r(() => {
              ...
              state.loadOptions.value = normalizeLoadOptions(
                state.loadOptions.value,
                loadOptions
              );
            ...
            this.logger?.setMinLogLevel(
              state.loadOptions.value.logLevel ?? POST_LOAD_LOG_LEVEL
          ...
          enqueuePreloadBufferEvents(bufferedEvents) {
            if (Array.isArray(bufferedEvents)) {
              bufferedEvents.forEach((bufferedEvent) =>
                this.preloadBuffer.enqueue(clone(bufferedEvent))
              );
            }
          }
          /**
          ...
          setAnonymousId(
            ...
            this.errorHandler.leaveBreadcrumb(`New ${type} invocation`);
            this.userSessionManager?.setAnonymousId(
              anonymousId,
              rudderAmpLinkerParam
            );
          } // eslint-disable-next-line class-methods-use-this
          ...
          consent(options, isBufferedInvocation = false) {
            ...
            r(() => {
              ...
              state.consents.postConsent.value =
                getValidPostConsentOptions(options);
          ...
          sendTrackingEvents(isBufferedInvocation) {
            ...
            if (state.consents.postConsent.value.trackConsent) {
              const trackOptions = trackArgumentsToCallOptions(
        ...
        class RudderAnalytics {
          ...
          constructor() {
            try {
              ...
              state.autoTrack.pageLifecycle.pageLoadedTimestamp.value =
                Date.now(); // start loading if a load event was buffered or wait for explicit load call
          ...
          getAnalyticsInstance(writeKey) {
            try {
              ...
              const analyticsInstanceExists = Boolean(
                this.analyticsInstances[instanceId]
              );
           ...
           */ // eslint-disable-next-line class-methods-use-this
          getPreloadedEvents() {
            return Array.isArray(globalThis.rudderanalytics)
          ...
          trackPageLifecycleEvents(preloadedEventsArray, loadOptions) {
            ...
            state.autoTrack.enabled.value =
              autoTrackEnabled || pageLifecycleEnabled;
          ...
          trackPageLoadedEvent(events, options, preloadedEventsArray) {
            if (
              events.length === 0 ||
              events.includes(PageLifecycleEvents.LOADED)
            ) {
          ...
          setupPageUnloadTracking(events, useBeacon, options) {
            if (
              events.length === 0 ||
              events.includes(PageLifecycleEvents.UNLOADED)
            ) {
              if (useBeacon === true) {
                  ...
                  if (isAccessible === false && state.lifecycle.loaded.value) {
                    ...
                    this.track(
                      ...
                      },
                      {
                        ...options,
                        originalTimestamp: getFormattedTimestamp(
                          new Date(pageUnloadedTimestamp)
                        ),
                      }
                    );
                  }
          ...
          reset(resetAnonymousId) {
            try {
              this.getAnalyticsInstance()?.reset(
                getSanitizedValue(resetAnonymousId)
              );
            } catch (error) {
              dispatchErrorEvent(error);
            }
          ...
          getAnonymousId(options) {
            try {
              return this.getAnalyticsInstance()?.getAnonymousId(
                getSanitizedValue(options)
              );
            } catch (error) {
              dispatchErrorEvent(error);
          ...
          startSession(sessionId) {
            try {
              this.getAnalyticsInstance()?.startSession(
                getSanitizedValue(sessionId)
              );
            } catch (error) {
              dispatchErrorEvent(error);
            }
          ...
          setAuthToken(token) {
            try {
              this.getAnalyticsInstance()?.setAuthToken(
                getSanitizedValue(token)
              );
            } catch (error) {
              dispatchErrorEvent(error);
            }
    ...
    "../../node_modules/ua-parser-js/src/main/ua-parser.mjs":
      ...
      (
        ...
        var isWindow = typeof window !== UNDEF_TYPE,
          NAVIGATOR =
            isWindow && window.navigator ? window.navigator : undefined,
          NAVIGATOR_UADATA =
            ...
            IData.prototype.is = function (strToCheck) {
              ...
              for (var i in this) {
                if (
                  ...
                  lowerize(
                    is_ignoreRgx ? strip(is_ignoreRgx, this[i]) : this[i]
                  ) ==
                    lowerize(
                      is_ignoreRgx
            ...
            switch (this.itemType) {
              case UA_BROWSER:
                ...
                if (brands) {
                  for (var i in brands) {
                    var brandName = strip(
                        /(Google|Microsoft) /,
                        brands[i].brand || brands[i]
                      ),
                      brandVersion = brands[i].version;
                    if (
                      !/not.a.brand/i.test(brandName) &&
                      (!prevName ||
                        (/chrom/i.test(prevName) && !/chromi/i.test(brandName)))
                    ) {
              ...
              case UA_OS:
                ...
                if (osName) {
                  ...
                  if (osName == WINDOWS)
                    osVersion =
                      parseInt(majorize(osVersion), 10) >= 13 ? "11" : "10";
  ...
  (() => {
    ...
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */
    var _experiment_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./experiment-manager */ "./src/experiment-manager/index.js"
    );
    /* harmony import */
    var _tracker_GameTracker__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./tracker/GameTracker */ "./src/tracker/GameTracker.js"
    );
    var _window$__OPTIONS__;
    // Imports
    ...
    if (
      ...
      _window$__OPTIONS__ === void 0
        ? void 0
        : _window$__OPTIONS__.currency) !== "DOGE"
    ) {
      var _window$__OPTIONS__2;
      // Log the version
      console.log("[RSA] ".concat("1.1.0"));
      var tracker =
        new _tracker_GameTracker__WEBPACK_IMPORTED_MODULE_1__.GameTracker();
      window.amplitude = tracker;
      // Create the appropriate Growthbook manager based on the flag
      var isExperimental = !!(
        (_window$__OPTIONS__2 = window.__OPTIONS__) !== null &&
        _window$__OPTIONS__2 !== void 0 &&
        _window$__OPTIONS__2.growthbook_flags
      );
    ...
    function createGrowthbookManager(isExperimental) {
      ...
      return isExperimental
        ? new _experiment_manager__WEBPACK_IMPORTED_MODULE_0__.BEGrowthbookExperimentManager(
            game,
            isEditor
          )
        : new _experiment_manager__WEBPACK_IMPORTED_MODULE_0__.GrowthbookExperimentManager(
            game,
            isEditor
          );
    }
